...
#Test case for starts_with_non_number
    def test_starts_with_non_number(self):
        ...
        self.assertEqual(pythonBasics3.starts_with_non_number("Four 5 6"), True)
        self.assertEqual(pythonBasics3.starts_with_non_number("This will pass 10 times"), True)
        self.assertEqual(pythonBasics3.starts_with_non_number("5 hamburgers please"), False)
...
#Test case for multiple_words
    def test_multiple_words(self):
        ...
        # Please add three more test cases following the order above
        self.assertEqual(pythonBasics3.multiple_words("  "), False)
        self.assertEqual(pythonBasics3.multiple_words("two sided"), True)
        self.assertEqual(pythonBasics3.multiple_words("will Pass"), True)
